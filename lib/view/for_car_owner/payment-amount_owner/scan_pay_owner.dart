...
class ScanPayScrrenOwner extends StatefulWidget {
  const ScanPayScrrenOwner({super.key});

  @override
  State<ScanPayScrrenOwner> createState() => _ScanPayScrrenOwnerState();
}

class _ScanPayScrrenOwnerState extends State<ScanPayScrrenOwner> {
